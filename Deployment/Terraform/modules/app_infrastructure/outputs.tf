...
output "main_vpc_endpoint_apigw_id" { value = module.main_vpc.vpc_endpoint_apigw_id }
...
output "main_vpc_endpoint_sqs_id" { value = module.main_vpc.vpc_endpoint_sqs_id }
