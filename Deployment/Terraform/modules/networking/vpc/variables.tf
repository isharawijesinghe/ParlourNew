...
variable "enable_athena_endpoint" { default = false }
variable "enable_kms_endpoint" { default = false }
variable "enable_logs_endpoint" { default = false }
variable "enable_monitoring_endpoint" { default = false }
variable "enable_s3_endpoint" { default = false }
variable "enable_secretsmanager_endpoint" { default = false }
variable "enable_ses_endpoint" { default = false }
variable "enable_sns_endpoint" { default = false }
variable "enable_sqs_endpoint" { default = false }
variable "enable_ssm_endpoint" { default = false }
variable "enable_ssmmessages_endpoint" { default = false }
