...
public class ChannelDAO implements ChannelDAOI{
    ...
    public Channel insertChannel(Channel channel){return channelRepositoryI.insert(channel);}

    public void deleteChannel(Channel channel){channelRepositoryI.delete(channel);}
